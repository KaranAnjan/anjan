...
// Changes here will automatically reflect in your generated PDF
...
export const cvData = {
  ...
  experience: [
    {
      ...
      endDate: 'Present',
      responsibilities: [
        'Developed full-stack business applications using Zoho Creator (Deluge), React, and SQL.',
        'Built automated workflows, APIs, and data pipelines across Zoho ecosystem.',
        'Designed MSSQL databases, stored procedures, and optimized queries.',
        'Implemented AI-based speech-to-text and summarization systems for sales calls.',
        'Integrated frontend interfaces using React and HTML for internal tools.',
      ],
    },
    {
  ...
  education: [
    {
      degree: 'MBA',
      specialization: 'Marketing & Finance (Dual Specialization)',
      institution: 'Cambridge Institute of Technology, VTU University',
  ...
  certifications: [
    ...
    { title: 'System Administration and IT Infrastructure Services', issuer: 'Google', year: '2023' },
    { title: 'Full-Stack Web Development', issuer: 'Self-Taught', year: '2024' },
    { title: 'Zoho Developer Specialization', issuer: 'Zoho', year: '2024' },
  ],
